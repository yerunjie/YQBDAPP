...
public class ModifyOccupationActivity extends YQBDBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_occupation);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editText.getText() ==  null || editText.getText().toString().isEmpty()){
                    Toast.makeText(ModifyOccupationActivity.this, "请输入信息", Toast.LENGTH_SHORT).show();
                } else {
                    userInfoBean.setOccupation(editText.getText().toString());
                    ...
                    addRequest(getService(UserApi.class).updateUserInfo(request), new YQBDBaseCallBack() {
                        ...
                        public void onSuccess200(Object o) {
                            Intent intent = new Intent(ModifyOccupationActivity.this, MyInfoActivity.class);
